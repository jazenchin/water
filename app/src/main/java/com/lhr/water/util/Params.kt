...
val MapDataList: List<RegionEntity> =
    listOf(
        ...
        RegionEntity( regionName = "第一區管理處", regionNumber = "01", deptName = "第一區管理處", deptNumber = "01", mapSeq = 1 ),
        ...
        RegionEntity( regionName = "第二區管理處", regionNumber = "02", deptName = "第二區管理處", deptNumber = "02", mapSeq = 1 ),
        RegionEntity( regionName = "第二區管理處", regionNumber = "02", deptName = "第二區管理處", deptNumber = "02", mapSeq = 2 ),
        ...
        RegionEntity( regionName = "第三區管理處", regionNumber = "03", deptName = "", deptNumber = "0340", mapSeq = 1 ),
        ...
        RegionEntity( regionName = "第五區管理處", regionNumber = "05", deptName = "第五區管理處", deptNumber = "05", mapSeq = 5 ),
        ...
        RegionEntity( regionName = "第五區管理處", regionNumber = "05", deptName = "斗南服務所", deptNumber = "0528", mapSeq = 1 ),
        ...
        RegionEntity( regionName = "第五區管理處", regionNumber = "05", deptName = "新港營運所", deptNumber = "0554", mapSeq = 1 ),
        ...
        RegionEntity( regionName = "第七區管理處", regionNumber = "07", deptName = "大崗山給水廠", deptNumber = "0761", mapSeq = 3 ),
        RegionEntity( regionName = "第七區管理處", regionNumber = "07", deptName = "大崗山給水廠", deptNumber = "0761", mapSeq = 4 ),
        ...
        RegionEntity( regionName = "第八區管理處", regionNumber = "08", deptName = "第八區管理處", deptNumber = "08", mapSeq = 1 ),
        RegionEntity( regionName = "第八區管理處", regionNumber = "08", deptName = "第八區管理處", deptNumber = "08", mapSeq = 2 ),
        ...
        RegionEntity( regionName = "第十一區管理處", regionNumber = "0B", deptName = "第十一區管理處", deptNumber = "0B", mapSeq = 1 ),
        RegionEntity( regionName = "第十一區管理處", regionNumber = "0B", deptName = "第十一區管理處", deptNumber = "0B", mapSeq = 2 ),
        RegionEntity( regionName = "第十一區管理處", regionNumber = "0B", deptName = "第十一區管理處", deptNumber = "0B", mapSeq = 3 ),
        RegionEntity( regionName = "第十一區管理處", regionNumber = "0B", deptName = "第十一區管理處", deptNumber = "0B", mapSeq = 4 ),
        ...
        RegionEntity( regionName = "第十二區管理處", regionNumber = "0C", deptName = "第十二區管理處", deptNumber = "0C", mapSeq = 1 ),
        RegionEntity( regionName = "第十二區管理處", regionNumber = "0C", deptName = "第十二區管理處", deptNumber = "0C", mapSeq = 2 ),
        RegionEntity( regionName = "第十二區管理處", regionNumber = "0C", deptName = "第十二區管理處", deptNumber = "0C", mapSeq = 3 ),
